...
class CallbackModule(CallbackBase):
    ...
    def __init__(self):
        ...
        self.tree = TREE_DIR
        if not self.tree:
            self.tree = os.path.expanduser("/home/ansible/tree")
            self._display.warning("The tree callback is defaulting to home/ansible/tree, as an invalid directory was provided: %s" % self.tree)
